...
namespace VGame.GameLogic.Editor.LuaUI
{
    ...
    {
        #region Constants
        private const string TEMPLATE_PATH = "Packages/LxyGame/LxyGame.Logic/Editor/UI/LuaUI/BaseLogicCodeTemplate.txt";
        private const string TEMPLATE_AUTO_PATH = "Packages/LxyGame/LxyGame.Logic/Editor/UI/LuaUI/BaseLogicCodeTemplate_Auto.txt";
