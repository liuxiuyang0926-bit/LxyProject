...
namespace XLua.CSObjectWrap
{
    ...
    {
        private static LxyDemo.SceneManagement.GameSceneManager
            GetSceneManager(
                ...
                int index)
        {
            translator.Get(
                state,
                index,
                out LxyDemo.SceneManagement.GameSceneManager value);
            return value;
        }
        ...
        static int _m_LoadSceneAsync(RealStatePtr L)
        {
		    try {
                ...
                LxyDemo.SceneManagement.GameSceneManager gen_to_be_invoked = GetSceneManager(translator, L, 1);
